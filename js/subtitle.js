function getRandomGreeting() {
  var greetings = [
    "Beep boop! Are you a robot? (your are)",
    ...
    "Shoutout to Clarkey (Aftermath)!",
    "Shoutout to Kobraking!",
    "Woo! /g/",
    "youtube.com/watch?v=dQw4w9WgXcQ (RICK ROLL!)",
    "youtube.com/@tjayau",
    ...
    "i do love buying birth certificates from the black market! - Clarkey",
    "'If you are trash go play Fortnite you loser' - Sun Tzu, Art of war",
    "Alfred is not a furry I swear",
